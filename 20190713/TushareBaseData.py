...
class TushareBaseData(object):
    ...
    def stockBasic(self):
        ...
        for _listName in self.listName.split(","):
            ...
            result.to_sql(self.GetDict().get(_listName), engine, if_exists= "append")
    ...
    def nameChange(self):
        ...
        for tsCode in result["ts_code"]:
            ...
            nameChange_result.to_sql("namechange", engine, if_exists="append")
